      ...
      <div class="offcanvas-body">
        <ul class="list-unstyled ps-0">
          <li class="mb-1">
            ...
            <div class="collapse show" id="home-collapse" style="padding-left:33px">
              <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                <li>
                  <button class="btn btn-toggle btn-sm align-items-center rounded">
                    Overview
                  </button>
                </li>
                <li>
          ...
          <li class="mb-1">
            ...
            <div class="collapse" id="dashboard-collapse" style="padding-left:33px">
              <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                <li>
                  <button class="btn btn-toggle btn-sm align-items-center rounded">
                    Overview
          ...
          <li class="mb-1">
            ...
            <div class="collapse" id="orders-collapse" style="padding-left:33px">
              <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                <li>
                  <button class="btn btn-toggle btn-sm align-items-center rounded">
                    New
          ...
          <li class="mb-1">
            ...
            <div class="collapse" id="account-collapse" style="padding-left:33px">
              <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                <li>
                  <button class="btn btn-toggle btn-sm align-items-center rounded">
                    New...
