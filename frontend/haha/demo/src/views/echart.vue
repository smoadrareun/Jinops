<template>
  <div class="all">
    <div class="top">
           <div class="sign">
      <span class="fast-flicker">b站</span>数据<span class="flicker">分析</span>展示
    </div>
    </div>
    <div class="main">
        <div class="up">
...
export default {
  ...
  methods: {
      setMyEchart1(){
          let myChart = this.$refs.one  //找到要变成echart的节点
  ...
  show:false
      ...
      setMyEchart2(){
 let myChart = this.$refs.two  //找到要变成echart的节点
 ...
 let option = {
  ...
  grid: {
    ...
    yAxis: [{
        ...
        data: ['鸡汤来了', '记录生活的蛋黄派', '如果把中国历史浓缩成一天', '我们会错过什么？', '凤凰涅槃吧！', '《2022热梗年度总结》', '写字不好看可以怪笔吗？', '一张游戏卡引发的蝴蝶效应', '千万不要随便锯桌子腿', '特效炸裂！年度之战！']
    }, {
    ...
    series: [{
            ...
            type: 'bar',
            yAxisIndex: 0,
            data: [1125000, 1326000, 1524000, 1981000, 2315000, 3504000, 4189000, 4237000, 5144000, 5453000],
            label: {
                normal: {
                    show: true,
                    position: 'right',
 ...
 thisChart.setOption(option);  //将编写好的配置项挂载到Echarts容器上
   ...
   grid: {
    ...
    yAxis: [{
            ...
            data: ['哔哩哔哩漫画', '哔哩哔哩大会员', '罗翔说刑法', '老番茄', '敬汉卿','共青团中央', '周六野Zoey', '绵羊料理', '凉风Kaze', '哔哩哔哩直播']
        }
    ...
    series: [{
            ...
            barGap: '0%',
            barCategoryGap: '50%',
            data: [33240000, 19080000, 18336000, 16120000, 9222000,8894000, 8453000, 8415000, 8172000, 8114000]
        }
      ...
      setMyEchart5(){
        ...
        let option = {
            backgroundColor:'#031d33',
           title: {
    text: '各等级用户数量(因b站总用户过多故样本设为6223人)',
    textStyle: {
      color: '#235894'
    }
  },
