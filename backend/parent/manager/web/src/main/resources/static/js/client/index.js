    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.code === 0) {
                ...
                $("#top").append(str);
                str="<li class=\"nav-more padding-little-top\" class=\"text-black\"><a href=\"#\">我的商城<span class=\"arrow\"></span></a>\n" +
                    "                    <ul class=\"drop-menu\">\n" +
                    "                        <a href=\"cart.html\" target=\"right\">购物车</a></li>\n" +
                    "                        <a href=\"order.html\" target=\"right\">历史订单</a></li>\n" +
                    "                    </ul>\n" +
                    "                </li>\n" +
                    "                <li class=\"nav-more padding-little-top\" class=\"text-black\"><a href=\"#\">用户设置<span class=\"arrow\"></span></a>\n" +
                    "                    <ul class=\"drop-menu\">\n" +
                    ...
                    "                </li>";
                $("#topnav").append(str);
                $("input[name='id']").val(data.data.client.id);
                $("#uname").text(data.data.client.uname);
                var img=data.data.client.pic;
...
function userInfo(){
    ...
    if(pic===""||pic===null||pic===undefined){
        ...
        $.ajax({
            ...
            data: data,
            async: false,
            url: window.location.origin + "/Jinops/client/insertAddInfo",
            success: function (data) {
                if (data.code === 0) {
                    window.scrollTo('0','0');
                    $("#tips").html(success).on("click",".close",function(){
