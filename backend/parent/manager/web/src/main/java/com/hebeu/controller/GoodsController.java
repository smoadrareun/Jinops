...
//        }else{
//            return msg.success("查询所有商品数据成功","List",list);
//        }
//    }
//
//    //根据商品id查询数据
...
//        }else{
//            return msg.success("根据商品id查询数据成功","Model",goodsModel);
//        }
//    }
//
//    //精确查询商品数据
...
//        }else{
//            return msg.success("精确查询商品数据成功","List",list);
//        }
//    }
//
//    //模糊查询商品数据
...
//        }else{
//            return msg.success("模糊查询商品数据成功","List",list);
//        }
//    }
//
//    //添加商品数据
...
//        }else{
//            return msg.success("请求查询商品数据成功","Map",resultMap);
//        }
//    }
//}
